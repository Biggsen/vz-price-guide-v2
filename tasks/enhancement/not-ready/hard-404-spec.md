...
- **Explicit list of “known route” rewrites**: must enumerate static + dynamic route patterns from `src/router/index.js` (e.g. `/edit/*`, `/shop/*`, `/recipes/*`, `/admin/*`) and define rule order to avoid breaking deep links.
