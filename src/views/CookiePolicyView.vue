...
<template>
	<div class="prose mt-6">
		<span
			...
			"></span>
		<div>
			<h1 class="text-3xl font-bold mb-2 text-gray-800">COOKIE POLICY</h1>
			<div class="mb-10">
				<strong>
			...
			<p>
				...
				<strong>verzion's price guide</strong>
				) are called "first-party cookies." Cookies set by parties other than the website
			...
			<h2 id="control">How can I control cookies?</h2>
			<p>
			...
			<section>
				<table class="cookie-table">
					<tbody>
						...
						<tr>
							<th>Provider:</th>
							<td>.minecraft-economy-price-guide.net</td>
						</tr>
						<tr>
							<th>Service:</th>
							<td>
			...
			<p>
				...
				unique identifier that enables us to recognize when someone has visited our Website
			...
			<p>
				...
				or "LSOs") to, among other things, collect and store information about your use of
