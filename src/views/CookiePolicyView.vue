		...
		<div data-custom-class="body">
			...
			<div>
				<span>
					<span>
						<strong>
							<span data-custom-class="heading_1"><h2>What are cookies?</h2></span>
						</strong>
					</span>
				</span>
			</div>
							...
							<table>
								<tbody>
									...
									<tr
										...
										<td>
											<span>.minecraft-economy-price-guide.net</span>
										</td>
									</tr>
									<tr
										style="
									...
									<tr
										...
										<td>
											<span>1 year 1 month 4 days</span>
										</td>
									</tr>
								</tbody>
							</table>
			...
			<div>
				<span data-custom-class="heading_1">
					<strong><h2>Do you use Flash cookies or Local Shared Objects?</h2></strong>
				</span>
			</div>
			<div>
				<span>
...
<script setup>
// This page will be populated with cookie policy content later
</script>
