<template>
	<div class="prose mt-6">
		...
		<div data-custom-class="body">
			...
			<div>
				...
				<div>
					<a data-custom-class="link" href="#prohibited">
						<span>
							<span data-custom-class="body_text">5. PROHIBITED ACTIVITIES</span>
						</span>
					</a>
				...
				<div>
					...
					<a data-custom-class="link" href="#copyrightyes">
						<span>
							<span data-custom-class="body_text">12. COPYRIGHT INFRINGEMENTS</span>
						</span>
					</a>
					<span>
						<span data-custom-class="body_text">
				...
				<div>
					<a data-custom-class="link" href="#terms">
						<span>
							<span data-custom-class="body_text">13. TERM AND TERMINATION</span>
						</span>
					</a>
				...
				<div>
					<a data-custom-class="link" href="#disputes">
						<span>
							<span data-custom-class="body_text">16. DISPUTE RESOLUTION</span>
						</span>
					</a>
				...
				<div>
					<a data-custom-class="link" href="#liability">
						<span>
							<span data-custom-class="body_text">19. LIMITATIONS OF LIABILITY</span>
						</span>
					</a>
			...
			<!-- 16 -->
			<div>
				<div data-custom-class="heading_1" id="disputes">
					<strong>
						<span>
				...
				<div data-custom-class="body_text">
					<span>The European Commission provides an&nbsp;</span>
					<span>
						<a
							data-custom-class="link"
				...
				<div>
					<bdt class="statement-end-if-in-editor"><bdt class="else-block"></bdt></bdt>
				</div>
			</div>
			<!-- 17 -->
			<div>
				<div data-custom-class="heading_1" id="corrections">
					<strong>
						<span>
			...
			<!-- 18 -->
			<div>
				<div data-custom-class="heading_1" id="disclaimer">
					<span>
						<strong><h2>18. DISCLAIMER</h2></strong>
					</span>
				</div>
				<div data-custom-class="body_text">
					<span>
						...
						IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED
			...
			<!-- 19 -->
			<div>
				<div data-custom-class="heading_1" id="liability">
					<strong>
						<span>
			...
			<!-- 20 -->
			<div>
				<div data-custom-class="heading_1" id="indemnification">
					<strong>
						<span>
			...
			<!-- 21 -->
			<div>
				<div data-custom-class="heading_1" id="userdata">
					<strong>
						<span>
							<h2>21. USER DATA</h2>
						</span>
			...
			<!-- 22 -->
			<div>
				<div data-custom-class="heading_1" id="electronic">
					<strong>
						<span>
			...
			<!-- 25 -->
			<div>
				<div data-custom-class="heading_1" id="contact">
					<strong>
						<span>
							<span>
								<h2>25. CONTACT US</h2>
				...
				<div data-custom-class="body_text">
					<span>
						<span>
							<bdt class="question"><strong>verzion's price guide</strong></bdt>
