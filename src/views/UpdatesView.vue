<template>
	<main class="container px-4 py-6">
		<div class="max-w-4xl">
			...
			<!-- Updates Section -->
			<section class="mb-12">
				<h2 class="text-2xl font-semibold mb-6 text-gray-700 border-b-2 border-gray-asparagus pb-2">
					Recent Updates
				</h2>
				...
				<div class="space-y-6">
					...
					>
						<div class="flex justify-between items-start mb-3">
							...
							<span class="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded whitespace-nowrap">
					...
					>
						...
						<div v-if="phase.features && phase.features.length" class="mb-4">
							...
							<ul class="space-y-2">
								...
								>
									...
									<span 
										:class="feature.completed ? 'line-through text-gray-500' : 'text-gray-700'"
										class="text-sm"
									>
										{{ feature.name }}
									</span>
						...
						<div v-if="phase.status === 'In Progress'" class="bg-blue-50 p-3 rounded">
							<div class="flex justify-between items-center mb-1">
								...
								<span class="text-sm text-blue-600">{{ calculateProgress(phase) }}%</span>
							</div>
...
const updates = ref(updatesData.map(update => ({
	...update,
